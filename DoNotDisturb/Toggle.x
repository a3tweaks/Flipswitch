...
@interface DoNotDisturbToggle : NSObject <A3Toggle>
@end
...
- (void)_reportAppLaunchFinished
{
	...
	void (^handler)(int value) = ^(int value){
		enabled = value & 1;
		[[A3ToggleManager sharedToggleManager] stateDidChangeForToggleIdentifier:[NSBundle bundleForClass:[DoNotDisturbToggle class]].bundleIdentifier];
	};
...
@implementation DoNotDisturbToggle
